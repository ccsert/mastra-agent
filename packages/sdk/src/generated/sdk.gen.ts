...
export const revokeMyOtherSessions = <ThrowOnError extends boolean = false>(options: Options<RevokeMyOtherSessionsData, ThrowOnError>): RequestResult<RevokeMyOtherSessionsResponses, RevokeMyOtherSessionsErrors, ThrowOnError> => (options.client ?? client).post<RevokeMyOtherSessionsResponses, RevokeMyOtherSessionsErrors, ThrowOnError>({
...
export const unarchiveProject = <ThrowOnError extends boolean = false>(options: Options<UnarchiveProjectData, ThrowOnError>): RequestResult<UnarchiveProjectResponses, UnarchiveProjectErrors, ThrowOnError> => (options.client ?? client).post<UnarchiveProjectResponses, UnarchiveProjectErrors, ThrowOnError>({
...
export const decideRunApproval = <ThrowOnError extends boolean = false>(options: Options<DecideRunApprovalData, ThrowOnError>): RequestResult<DecideRunApprovalResponses, DecideRunApprovalErrors, ThrowOnError> => (options.client ?? client).post<DecideRunApprovalResponses, DecideRunApprovalErrors, ThrowOnError>({
